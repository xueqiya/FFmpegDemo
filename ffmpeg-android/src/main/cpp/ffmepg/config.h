...
#define FFMPEG_CONFIGURATION "--prefix=/root/ffmpeg/android/armv7-a --extra-cflags='-Os -fpic -mfloat-abi=softfp -mfpu=vfp -marm -march=armv7-a ' --extra-cflags=-I//root/ffmpeg/fdk-aac/android/armv7/include --extra-ldflags=-L//root/ffmpeg/fdk-aac/android/armv7/lib --extra-cflags=-I//root/ffmpeg/openssl/android/armv7/include --extra-ldflags=-L//root/ffmpeg/openssl/android/armv7/lib --extra-ldflags= --disable-static --enable-shared --disable-debug --enable-cross-compile --enable-small --enable-gpl --enable-nonfree --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avfilter --disable-avdevice --disable-swscale --disable-programs --disable-swresample --disable-doc --disable-runtime-cpudetect --disable-htmlpages --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-network --enable-jni --disable-everything --enable-protocol=file --enable-protocol=http --enable-protocol=tcp --enable-protocol=rtmp --enable-protocol=hls --enable-demuxer=avi --enable-demuxer=mkv --cross-prefix=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=android --arch=arm --cpu=armv7-a --cc=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang --cxx=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang++ --nm=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --strip=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-strip --sysroot=/root/androidndk20b/toolchains/llvm/prebuilt/linux-x86_64/sysroot"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/root/ffmpeg/android/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "/root/ffmpeg/android/armv7-a/share/ffmpeg"
