...
our %config = (
  ...
  prefix => "/Users/xueqi/Projects/FFmpegDemo/ffmpeg/openssl/android/armv8-a",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-arm",
  chacha_asm_src => "chacha_enc.c",
  chacha_obj => "chacha_enc.o",
  cmll_asm_src => "camellia.c cmll_misc.c cmll_cbc.c",
  cmll_obj => "camellia.o cmll_misc.o cmll_cbc.o",
  cppflags => "-D__ANDROID_API__=21 -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include/arm-linux-androideabi -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include",
  cpuid_asm_src => "mem_clr.c",
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-arm",
  defines => [  ],
