...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/Users/xueqi/sdk/android/ndk/androidndk20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang",
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/Users/xueqi/sdk/android/ndk/androidndk20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Users/xueqi/sdk/android/ndk/androidndk20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_COMP", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_RC5" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_STATIC_ENGINE", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "-D__ANDROID_API__=21 --prefix=/Users/xueqi/Projects/my/FFmpegDemo/ffmpeg4.3.1/openssl/android/armv8-a no-afalgeng no-asan no-asm no-buildtest-c++ no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-idea no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.28.2",
  perlargv => [ "-D__ANDROID_API__=21", "--prefix=/Users/xueqi/Projects/my/FFmpegDemo/ffmpeg4.3.1/openssl/android/armv8-a", "android-arm64", "no-ssl2", "no-comp", "no-asm", "no-idea", "no-hw", "no-engine", "no-dso" ],
  perlenv => {
      "AR" => "/Users/xueqi/sdk/android/ndk/androidndk20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android-ar",
      "BUILDFILE" => undef,
      "CC" => "/Users/xueqi/sdk/android/ndk/androidndk20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang",
      "CFLAGS" => undef,
      "CPPFLAGS" => undef,
  ...
  prefix => "/Users/xueqi/Projects/my/FFmpegDemo/ffmpeg4.3.1/openssl/android/armv8-a",
  processor => "",
  rc4_int => "unsigned char",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target aarch64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-arm64",
  chacha_asm_src => "chacha_enc.c",
  chacha_obj => "chacha_enc.o",
  cmll_asm_src => "camellia.c cmll_misc.c cmll_cbc.c",
  cmll_obj => "camellia.o cmll_misc.o cmll_cbc.o",
  cppflags => "-D__ANDROID_API__=21 -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include/aarch64-linux-android -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include",
  cpuid_asm_src => "mem_clr.c",
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  -target aarch64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-arm64",
  defines => [  ],
