...
Java_com_apkmatrix_components_ffmpeg_jni_FFmpegJni_run(JNIEnv *env,jclass clazz,jint cmdnum,jobjectArray cmdline) {
...
Java_com_apkmatrix_components_ffmpeg_jni_FFmpegJni_exit(JNIEnv *env, jclass type) {
